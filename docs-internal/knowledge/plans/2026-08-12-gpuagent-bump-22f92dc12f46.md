# Automated gpuagent bump to ROCm/gpu-agent main @22f92dc12f46
...
- Bump `GPUAGENT_COMMIT` from `06c28090845b86f385625da51e45c3fc2b479f75` to
  `22f92dc12f464f70d47ccf9ee87dadf577cf9574` in both pin locations:
  - `Makefile`
  - `docker/Dockerfile.exporter-release`
- No change: gpu-agent's `go.mod` still pins go1.25.12, matching the current `GO_VERSION` pin.
