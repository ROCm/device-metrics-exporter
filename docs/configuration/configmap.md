...
```bash
helm install exporter https://github.com/ROCm/device-metrics-exporter/releases/download/v1.5.4/device-metrics-exporter-charts-v1.5.4.tgz -n metrics-exporter -f values.yaml --create-namespace
```
